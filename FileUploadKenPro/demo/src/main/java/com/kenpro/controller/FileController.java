	 ...
	 @GetMapping("/{id}/download")
	    public ResponseEntity<byte[]> downloadFile(@PathVariable Long id) {
	        ...
	        return ResponseEntity.ok()
	        		  .contentType(MediaType.parseMediaType(file.getDocumentType())) // Use actual file type
	                  .header(HttpHeaders.CONTENT_DISPOSITION, "inline; filename=\"" + file.getDocumentName() + "\"") // "inline" instead of "attachment"
